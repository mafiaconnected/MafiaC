...
#define LAUNCHER_MINOR 3
#define LAUNCHER_PATCH 1
#define LAUNCHER_BUILD 0
#define LAUNCHER_VERSION_PATCH_STRING "1"
#define LAUNCHER_VERSION "1.3.1.0"
#define LAUNCHER_DISPLAY_VERSION "1.3.1"
