...
"..\..\..\..\Tools\7z.exe" a postupdate.tar -xr!DebugTest.dll -xr!d3d8to9.dll -xr!MafiaC.pdb -xr!Launcher.pdb -xr!mozjs-*.pdb -xr!Updater.pdb Launcher.exe *.dll *.pdb Hacks\*.dll Engine\*.exe Engine\*.dll ..\..\..\..\Setup\resources MafiaC.tar
