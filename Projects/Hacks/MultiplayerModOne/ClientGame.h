...
public:
	...
	void HumanHit(CClientHuman* pClientHumanTarget, CClientEntity* pAttacker, CVector3D vec1, CVector3D vec2, CVector3D vec3, int uiHitType, float fDamage, int uiBodyPart);
